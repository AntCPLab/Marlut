...
pub fn generate_random_ohv16(
    party: &mut WL16ASParty,
    n: usize,
    use_bitstring_check: bool,
) -> MpcResult<Vec<RndOhv16Output>> {
    if use_bitstring_check {
        wollut16::offline::generate_random_ohv16_bitstring(
            &mut party.inner,
            &mut party.gf64_triples_to_check,
            n,
        )
    } else {
        wollut16::offline::generate_random_ohv16(
            &mut party.inner,
            &mut party.gf2_triples_to_check,
            n,
        )
    }
}
...
pub fn generate_random_ohv16_mt(
    ...
    if use_bitstring_check {
        wollut16::offline::generate_random_ohv16_bitstring_mt(
            &mut party.inner,
            &mut party.gf64_triples_to_check,
            n,
        )
    } else {
        wollut16::offline::generate_random_ohv16_mt(
            &mut party.inner,
            &mut party.gf2_triples_to_check,
            n,
        )
...
mod test {
    ...
    use crate::{
        wollut16::offline::test::check_correct_rnd_ohv16,
        wollut16_malsec::{
            WL16ASParty,
            offline::{generate_random_ohv16, generate_random_ohv16_mt},
            test::{WL16ASSetup, WL16BitString, WL16DefaultParams},
        },
    };
    ...
    fn random_ohv16() {
        ...
        let ((o1, _), (o2, _), (o3, _)) =
            WL16ASSetup::<WL16DefaultParams>::localhost_setup(program(), program(), program());
        assert_eq!(o1.len(), N);
        assert_eq!(o2.len(), N);
        assert_eq!(o3.len(), N);
    ...
    fn random_ohv16_mt() {
        ...
        let ((o1, _), (o2, _), (o3, _)) =
            WL16ASSetup::<WL16DefaultParams>::localhost_setup_multithreads(
                N_THREADS,
                program(),
                program(),
                program(),
    ...
    fn random_ohv16_bitstring_check() {
        ...
        let ((o1, _), (o2, _), (o3, _)) =
            WL16ASSetup::<WL16BitString>::localhost_setup(program(), program(), program());
        assert_eq!(o1.len(), N);
        assert_eq!(o2.len(), N);
        assert_eq!(o3.len(), N);
        check_correct_rnd_ohv16(o1, o2, o3);
    ...
    fn random_ohv16_mt_bitstring_check() {
        ...
        let ((o1, _), (o2, _), (o3, _)) =
            WL16ASSetup::<WL16BitString>::localhost_setup_multithreads(
                N_THREADS,
                program(),
                program(),
                program(),
