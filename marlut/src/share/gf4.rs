...
use super::{Empty, Field, FieldLike, gf4_bs_table};
...
impl BasicFieldLike for GF4 {}

impl FieldLike for GF4 {
...
impl MulAssign for GF4 {
    fn mul_assign(&mut self, rhs: Self) {
        self.0 = MUL_TABLE[self.0 as usize][rhs.0 as usize];
    }
}

impl Add<Empty> for GF4 {
    type Output = Self;
    fn add(self, _rhs: Empty) -> Self::Output {
        self
    }
}
impl Sub<Empty> for GF4 {
    type Output = Self;
    fn sub(self, _rhs: Empty) -> Self::Output {
        self
    }
}
impl Mul<Empty> for GF4 {
    type Output = Empty;
...
impl BasicFieldLike for BsGF4 {}

impl FieldLike for BsGF4 {
    const NBYTES: usize = 1;
...
impl MulAssign for BsGF4 {
    fn mul_assign(&mut self, rhs: Self) {
        self.0 = gf4_bs_table::MULT_TABLE[self.0 as usize][rhs.0 as usize];
    }
}
...
impl Add<Empty> for BsGF4 {
    type Output = Self;
    fn add(self, _rhs: Empty) -> Self::Output {
        self
    }
}
impl Sub<Empty> for BsGF4 {
    type Output = Self;
    fn sub(self, _rhs: Empty) -> Self::Output {
        self
    }
}
impl Mul<Empty> for BsGF4 {
    type Output = Empty;
    fn mul(self, _rhs: Empty) -> Self::Output {
        Empty
    }
...
mod test {
    ...
    fn serialization() {
        ...
        GF4::from_byte_slice(GF4::as_byte_vec_slice(&list_even), &mut slice_even);
