...
/// An element in `GF(2)^16`, i.e. a vector of 16 booleans.
...
impl BasicFieldLike for BsBool16 {}

impl FieldLike for BsBool16 {
...
impl Add<Empty> for BsBool16 {
    type Output = Self;
    fn add(self, _rhs: Empty) -> Self::Output {
        self
    }
}
impl Sub<Empty> for BsBool16 {
    type Output = Self;
    fn sub(self, _rhs: Empty) -> Self::Output {
        self
    }
}
impl Mul<Empty> for BsBool16 {
    type Output = Empty;
