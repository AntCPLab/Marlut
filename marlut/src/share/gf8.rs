...
use crate::share::BasicFieldLike;
use crate::share::gf8_tables;
use crate::share::{Empty, Field};
...
impl BasicFieldLike for GF8 {}

impl FieldLike for GF8 {
...
impl MulAssign for GF8 {
    fn mul_assign(&mut self, rhs: Self) {
        self.0 = gf8_tables::MUL_TABLE[self.0 as usize][rhs.0 as usize];
    }
}
