...
pub fn random_state<Protocol: Party>(party: &mut Protocol, size: usize) -> VectorAesState {
...
pub mod test {
    ...
    use crate::{
        aes::{
            INV_GF8, aes128_inv_no_keyschedule, aes128_keyschedule, aes128_no_keyschedule,
            sbox_layer,
        },
        share::{
            gf8::GF8,
    ...
    use super::{
        AesKeyState, AesVariant, ArithmeticBlackBox, GF8InvBlackBox, VectorAesState,
        aes256_keyschedule,
    };
    ...
    // FIPS 197 Appendix B
    pub const AES128_TEST_INPUT: [u8; 16] = [
        0x32, 0x43, 0xf6, 0xa8, 0x88, 0x5a, 0x30, 0x8d, 0x31, 0x31, 0x98, 0xa2, 0xe0, 0x37, 0x07,
        0x34,
    ];
    pub const AES128_TEST_EXPECTED_OUTPUT: [u8; 16] = [
    ...
    pub const AES256_TEST_KEY: [u8; 32] = [
    ...
    pub const AES256_TEST_ROUNDKEYS: [[u8; 16]; 15] = [
        // already in row-first representation
        [
            0x60, 0x15, 0x2b, 0x85, 0x3d, 0xca, 0x73, 0x7d, 0xeb, 0x71, 0xae, 0x77, 0x10, 0xbe,
            0xf0, 0x81,
        ],
        [
            0x1f, 0x3b, 0x2d, 0x09, 0x35, 0x61, 0x98, 0x14, 0x2c, 0x08, 0x10, 0xdf, 0x07, 0xd7,
            0xa3, 0xf4,
        ],
        [
            0x9b, 0x8e, 0xa5, 0x20, 0xa3, 0x69, 0x1a, 0x67, 0x54, 0x25, 0x8b, 0xfc, 0x11, 0xaf,
            0x5f, 0xde,
        ],
        [
            0xa8, 0x93, 0xbe, 0xb7, 0xb0, 0xd1, 0x49, 0x5d, 0x9c, 0x94, 0x84, 0x5b, 0x1a, 0xcd,
            0x6e, 0x9a,
        ],
        [
            0xd5, 0x5b, 0xfe, 0xde, 0x9a, 0xf3, 0xe9, 0x8e, 0xec, 0xc9, 0x42, 0xbe, 0xb8, 0x17,
            0x48, 0x96,
        ],
        [
            0xb5, 0x26, 0x98, 0x2f, 0xa9, 0x78, 0x31, 0x6c, 0x32, 0xa6, 0x22, 0x79, 0x8a, 0x47,
            0x29, 0xb3,
        ],
        [
            0x81, 0xda, 0x24, 0xfa, 0x2c, 0xdf, 0x36, 0xb8, 0x81, 0x48, 0x0a, 0xb4, 0xad, 0xba,
            0xf2, 0x64,
        ],
        [
            0x98, 0xbe, 0x26, 0x09, 0xc5, 0xbd, 0x8c, 0xe0, 0xbf, 0x19, 0x3b, 0x42, 0xc9, 0x8e,
            0xa7, 0x14,
        ],
        [
            0x68, 0xb2, 0x96, 0x6c, 0x00, 0xdf, 0xe9, 0x51, 0x7b, 0x33, 0x39, 0x8d, 0xac, 0x16,
            0xe4, 0x80,
        ],
        [
            0xc8, 0x76, 0x50, 0x59, 0x14, 0xa9, 0x25, 0xc5, 0xe2, 0xfb, 0xc0, 0x82, 0x04, 0x8a,
            0x2d, 0x39,
        ],
        [
            0xde, 0x6c, 0xfa, 0x96, 0x13, 0xcc, 0x25, 0x74, 0x69, 0x5a, 0x63, 0xee, 0x67, 0x71,
            0x95, 0x15,
        ],
        [
            0x58, 0x2e, 0x7e, 0x27, 0x86, 0x2f, 0x0a, 0xcf, 0xca, 0x31, 0xf1, 0x73, 0x5d, 0xd7,
            0xfa, 0xc3,
        ],
        [
            0x74, 0x18, 0xe2, 0x74, 0x9c, 0x50, 0x75, 0x01, 0x47, 0x1d, 0x7e, 0x90, 0xab, 0xda,
            0x4f, 0x5a,
        ],
        [
            0xca, 0xe4, 0x9a, 0xbd, 0xfa, 0xd5, 0xdf, 0x10, 0xaa, 0x9b, 0x6a, 0x19, 0xe3, 0x34,
            0xce, 0x0d,
        ],
        [
            0xfe, 0xe6, 0x04, 0x70, 0x48, 0x18, 0x6d, 0x6c, 0x90, 0x8d, 0xf3, 0x63, 0xd1, 0x0b,
            0x44, 0x1e,
        ],
    ];
    pub const AES256_TEST_EXPECTED_OUTPUT: [u8; 16] = [
        0x30, 0x21, 0x61, 0x3a, 0x97, 0x3e, 0x58, 0x2f, 0x4a, 0x29, 0x23, 0x41, 0x37, 0xae, 0xc4,
        0x94,
    ];
    ...
    >(
        ...
        for i in 0..15 {
            let (s1, s2, s3) =
                secret_share_aes_key_state(&mut rng, &AES256_TEST_ROUNDKEYS[i].map(|x| GF8(x)));
            ks1.push(s1);
            ks2.push(s2);
            ks3.push(s3);
        }
    ...
    >(
        ...
        let mut rng = thread_rng();
        let (key1, key2, key3) = transpose(
            AES256_TEST_KEY
                .into_iter()
                .map(|x| secret_share(&mut rng, &GF8(x))),
        );
