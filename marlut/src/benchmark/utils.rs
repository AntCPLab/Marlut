...
use crate::rep3_core::{
    ...
    party::{CombinedCommStats, error::MpcResult},
};
use crate::{
    aes::{self, AesVariant, GF8InvBlackBox},
    share::gf8::GF8,
        ...
        for prot in &protocols {
            ...
            let agg = benchmark(
                ...
                *simd_i,
                ...
                prot,
                format!(
                    "{} current benchmark [protocol: {}, simd: {}]",
                    &benchmark_prot_string,
                    prot.protocol_name(),
                    *simd_i
                ),
            );
...
where
    F: FnOnce(ConnectedParty, Option<usize>, Option<String>) -> Protocol,
...
pub(crate) fn run_benchmark_no_prep<
    Protocol: GF8InvBlackBox,
    ABB: ArithmeticBlackBox<GF8>,
    F,
    H,
    J,
>(
    ...
    J: FnOnce(&mut Protocol) -> MpcResult<()>,
{
    run_benchmark(
        ...
        setup_f,
        abb_f,
        None as Option<fn(&mut Protocol, usize, AesVariant) -> MpcResult<()>>,
        finalize_f,
    )
}

pub(crate) fn run_benchmark_no_finalize<
    Protocol: GF8InvBlackBox,
    ABB: ArithmeticBlackBox<GF8>,
    F,
    H,
    ...
    I: FnOnce(&mut Protocol, usize, AesVariant) -> MpcResult<()>,
{
    run_benchmark(
        ...
        abb_f,
        prep_f,
        None as Option<fn(&mut Protocol) -> MpcResult<()>>,
    )
}

pub(crate) fn run_benchmark_no_prep_no_finalize<
    Protocol: GF8InvBlackBox,
    ABB: ArithmeticBlackBox<GF8>,
    F,
    H,
