...
use crate::{
    ...
    wollut16_malsec::{PrepCheckType, WL16ASParty},
};
...
impl_benchmark_protocol!(
    ...
    |conn: ConnectedParty, n_worker_threads: Option<usize>, prot_str: Option<String>| {
        WL16ASParty::setup(
            conn,
            false,
            false,
            PrepCheckType::BitString,
            true,
            n_worker_threads,
            prot_str,
        )
    ...
    |party: &mut WL16ASParty, simd: usize, variant: AesVariant| party
        .do_preprocessing(0, simd, variant), // do preprocessing
