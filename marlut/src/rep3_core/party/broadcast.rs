...
mod test {
    ...
    fn broadcast_round() {
        ...
        let (((c1, x13, x12), _), ((c2, x21, x23), _), ((c3, x32, x31), _)) =
    ...
    fn open_rss() {
        ...
        let ((o1, _), (o2, _), (o3, _)) =
            PartySetup::localhost_setup(compute(x1), compute(x2), compute(x3));
    ...
    fn open_rss_to() {
        ...
        let ((open1, _), (open2, _), (open3, _)) =
            PartySetup::localhost_setup(program(x1), program(x2), program(x3));
